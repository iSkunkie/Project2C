...
elseif (isset($_POST['throw']) && isset($_POST['amountdice']))
{
    ...
    <form action="" method="POST">
        <div class="mb-3">
            ...
            <input type="number" min="0" max="20" class="form-control" id="ijsberen" name="ijsberen" aria-describedby="ijsberenHelp">
        </div>
    </form>
    <form action="" method="POST">
        <div class="mb-3">
            <label for="penguins" class="form-label">Hoeveel pinguïns?</label>
            <input type="number" min="0" max="40" class="form-control" id="wakken" name="wakken" aria-describedby="wakkenHelp">
        </div>
