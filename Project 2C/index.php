...
////Game __constructor
//$x = new \Proejct5\DiceList();
//$x->addDice(new \Proejct5\Dice());
//$x->addDice(new \Proejct5\Dice());
//$x->addDice(new \Proejct5\Dice());
//
////code om de dobbelstenen aan te tonen
//$alledices = $x->getDices();
//foreach ($alledices as $eendice){
//    $eendice->draw();
//}
...
elseif (isset($_POST['throw']) && isset($_POST['amountdice']))
{
    ...
    <form action="" method="POST">
        <div class="mb-3">
            ...
            <input type="number" min="0" max="10" class="form-control" id="wakken" name="wakken" aria-describedby="wakkenHelp" required>
        </div>
        <div class="mb-3">
            <label for="ijsberen" class="form-label">Hoeveel ijsberen</label>
            <input type="number" min="0" max="10" class="form-control" id="ijsberen" name="ijsberen" aria-describedby="ijsberenHelp" required>
        </div>
        <div class="mb-3">
...
elseif(isset($_POST['register']))
{
    ...
    <form action="" method="POST">
        <div class="mb-3">
            ...
            <input type="number" min="3" max="8" class="form-control" id="amountdice" name="amountdice" aria-describedby="amountdiceHelp" required placeholder="Keuze uit 3 t/m 8 dobbelstenen">
        </div>
